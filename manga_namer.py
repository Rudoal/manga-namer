...
input_language = input('The language: ')
...
for i, w in zip(images, images_width):
    ...
    if (((w + 20) or (w - 20) or w) in range((get_width_mode * 2), ((get_width_mode * 2) + 21))) or (((w + 20) or (w - 20) or w) in range((get_width_mode * 2), ((get_width_mode * 2) - 21))):
    ...
    os.rename(i, page_name)
    print(f'Renamed {i} to {page_name}')
